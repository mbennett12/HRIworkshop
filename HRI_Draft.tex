...
described in our previous work~\cite{yourIROSpaper}.
...
in our previous work~\cite{yourIROSpaper}. 
...
at least one when speaking to the teleoperated robot. Participants used significantly more words to describe the task in the
