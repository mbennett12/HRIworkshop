...
In addition to discussing our teleoperation interface, we now
share the findings of our study. We hypothesized \textbf{(H1)} that not only would robots described to
